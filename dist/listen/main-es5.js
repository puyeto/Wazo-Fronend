...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/content/layout/player/player.component.html":
  /*!***************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/content/layout/player/player.component.html ***!
    \***************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentLayoutPlayerPlayerComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentLayoutSectionSectionComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<!-- Begin | Section [[ Find at scss/base/core.scss ]] -->\n<div class=\"section\">\n    <div class=\"heading\">\n        <div class=\"d-flex flex-wrap align-items-end\">\n            <div class=\"flex-grow-1\">\n                <h4>{{section?.title}}</h4>\n                <p>{{section?.subTitle}}</p>\n            </div>\n            <a class=\"btn btn-sm btn-pill btn-air btn-primary\" routerLink=\"{{section?.page}}\">View All</a>\n        </div>\n        <hr>\n    </div>\n\n    <ngx-slick-carousel [class]=\"classes\" [config]=\"sliderConfig\">\n        <div ngxSlickItem *ngFor=\"let item of section?.items\" class=\"slide\">\n            <app-image-card *ngIf=\"imageCard\" [item]=\"item\" [imageBorderRadiusClass]=\"imageBorderRadiusClass\" [routeLink]=\"artistRouteLink ? '/artist/' + item.id + '/details' : ''\"></app-image-card>\n\n            <app-primary-card *ngIf=\"primaryCard\" [song]=\"item\" [showOptions]=\"showImageOptions\" [imageBorderRadiusClass]=\"imageBorderRadiusClass\"></app-primary-card>\n\n            <app-secondary-card *ngIf=\"secondaryCard\" [item]=\"item\" [imageBorderRadiusClass]=\"imageBorderRadiusClass\">\n            </app-secondary-card>\n        </div>\n    </ngx-slick-carousel>\n</div>\n<!-- End | Section -->";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppContentPartialsEventCardsEventCountdownCardEventCountdownCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div [class]=\"eventBorderRadiusClass\" [ngStyle]=\"{'background-image': 'url(' + musicEvent.image + ')'}\">\n    <div class=\"event-content p-4\">\n        <a [routerLink]=\"'/event/' + musicEvent.id + '/details'\">\n            <h6>{{musicEvent.name}}</h6>\n        </a>\n        <!-- <div class=\"mb-3\">\n            <app-countdown [text]=\"countText\" [showZero]=\"'0'\" units=\"Days | Hours | Minutes | Seconds\" [end]=\"musicEvent.date\"></app-countdown>\n        </div> -->\n        <!-- <button type=\"button\" class=\"btn btn-bold btn-pill btn-air btn-warning btn-sm\">Buy Ticket</button> -->\n    </div>\n</div>";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/image-card/image-card.component.html":
  /*!*************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/image-card/image-card.component.html ***!
    \*************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentPartialsImageCardImageCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"custom-card\" *ngIf=\"routeLink; else withoutLink\">\n    <a class=\"custom-card--link\" routerLink=\"{{routeLink}}\">\n        <div class=\"image\">\n            <img [src]=\"item.cover_url\" alt=\"{{item?.name}}\" [class]=\"imageBorderRadiusClass\">\n        </div>\n        <h6 class=\"mb-0 mt-2\">{{item?.name}}</h6>\n    </a>\n</div>\n\n<ng-template #withoutLink>\n    <div class=\"custom-card\">\n        <a class=\"custom-card--link\">\n            <div class=\"image\">\n                <img [src]=\"item.cover_url\" alt=\"{{item?.name}}\" [class]=\"imageBorderRadiusClass\">\n            </div>\n            <h6 class=\"mb-0 mt-2\">{{item?.name}}</h6>\n        </a>\n    </div>\n</ng-template>";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/main-cards/primary-card/primary-card.component.html":
  /*!****************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/main-cards/primary-card/primary-card.component.html ***!
    \****************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentPartialsMainCardsPrimaryCardPrimaryCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<!-- Begin | Custom Card [[ Find at scss/framework/components/custom-card/custom-card.scss ]] -->\r\n<div class=\"custom-card\">\r\n    <div [class]=\"classes\">\r\n        <!-- Begin | Custom Card Info -->\r\n        <div class=\"custom-card--info\" *ngIf=\"showOptions\">\r\n            <ul class=\"custom-card--labels d-flex\" *ngIf=\"song?.premium || song?.favorite\">\r\n                <li *ngIf=\"song?.premium\"><span class=\"badge badge-pill badge-warning\"><i class=\"la la-star\"></i></span></li>\r\n                <li *ngIf=\"song?.favorite\"><span class=\"badge badge-pill badge-danger\"><i class=\"la la-heart\"></i></span></li>\r\n            </ul>\r\n            <!-- Custom Card Options Dropdown -->\r\n            <div class=\"dropdown dropdown-icon\">\r\n                <a href=\"javascript:;\" role=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\r\n                    <i class=\"ion-md-more\"></i>\r\n                </a>\r\n                <ul class=\"dropdown-menu dropdown-menu-right\">\r\n                    <li class=\"dropdown-item\">\r\n                        <a href=\"javascript:;\" class=\"dropdown-link\" (click)=\"addFavorite()\">\r\n                            <i class=\"la la-heart-o\"></i>\r\n                        </a>\r\n                    </li>\r\n                    <li class=\"dropdown-item\">\r\n                        <a href=\"javascript:;\" class=\"dropdown-link\" (click)=\"addInQueue()\">\r\n                            <i class=\"la la-plus\"></i>\r\n                        </a>\r\n                    </li>\r\n                    <li class=\"dropdown-item\">\r\n                        <a [href]=\"song?.url\" class=\"dropdown-link\" download>\r\n                            <i class=\"la la-download\"></i>\r\n                        </a>\r\n                    </li>\r\n                    <li class=\"dropdown-item\">\r\n                        <a href=\"javascript:;\" class=\"dropdown-link\" (click)=\"shareSong()\">\r\n                            <i class=\"la la-share-alt\"></i>\r\n                        </a>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n        <!-- End | Custom Card Info -->\r\n        <a (click)=\"addInPlayer()\">\r\n            <div class=\"image\">\r\n                <img [src]=\"song?.cover_url\" alt=\"{{song?.name}}\">\r\n            </div>\r\n        </a>\r\n    </div>\r\n\r\n    <!-- Custom Card Options Dropdown -->\r\n    <a class=\"custom-card--link mt-2\" [routerLink]=\"'/song/' + song.id + '/details'\">\r\n        <h6 class=\"text-truncate\" title=\"{{song?.name}}\">{{song?.name.slice(0, 25)}}</h6>\r\n        <p class=\"text-truncate\" title=\"{{song?.artist}}\" *ngIf=\"song?.artist\">{{song?.artist}}</p>\r\n    </a>\r\n</div>\r\n<!-- Begin | Custom Card [[ Find at scss/framework/components/custom-card/custom-card.scss ]] -->";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/main-cards/secondary-card/secondary-card.component.html":
  /*!********************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/main-cards/secondary-card/secondary-card.component.html ***!
    \********************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentPartialsMainCardsSecondaryCardSecondaryCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/song-horizontal/song-horizontal.component.html":
  /*!***********************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/song-horizontal/song-horizontal.component.html ***!
    \***********************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentPartialsSongHorizontalSongHorizontalComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"song-h--img\">\n    <img [src]=\"song?.cover_url\" alt=\"{{song?.name}}\" [class]=\"imageBorderRadiusClass\">\n</div>\n<div class=\"song-h--desc\">\n    <span class=\"text-truncate song-h--name\" title=\"{{song?.name}}\">{{song?.name.slice(0, 25)}}</span>\n    <p class=\"text-truncate song-h--artist\" title=\"{{song?.artist}}\" *ngIf=\"song?.artist\">{{song?.artist}}</p>\n</div>";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/song-list-view/song-list-view.component.html":
  /*!*********************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/song-list-view/song-list-view.component.html ***!
    \*********************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentPartialsSongListViewSongListViewComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"song-list--item-number\">\r\n    {{songNumber\r\n    < 10 ? '0' + songNumber : songNumber}} </div>\r\n\r\n        <app-song-horizontal [song]=\"song\" [imageBorderRadiusClass]=\"imageBorderRadiusClass\" [playlist]=\"playlist\" [songIndex]=\"songIndex\"></app-song-horizontal>\r\n\r\n        <ul class=\"custom-card--labels d-flex ml-auto\">\r\n            <li *ngIf=\"song?.favorite\"><span class=\"badge badge-pill badge-danger\"><i class=\"la la-heart\"></i></span></li>\r\n            <li *ngIf=\"song?.premium\"><span class=\"badge badge-pill badge-warning\"><i class=\"la la-star\"></i></span></li>\r\n            <li class=\"ml-4\">\r\n                <app-song-options [icon]=\"icon\" [song]=\"song\"></app-song-options>\r\n            </li>\r\n        </ul>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _content_layout_layout_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./content/layout/layout.module */
    "./src/app/content/layout/layout.module.ts");
    /* harmony import */


    var _content_layout_loader_loader_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./content/layout/loader/loader.component */
    "./src/app/content/layout/loader/loader.component.ts");
    /* harmony import */


    var _core_services_loading_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./core/services/loading.service */
    "./src/app/core/services/loading.service.ts");
    /* harmony import */


    var _core_services_menu_config_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./core/services/menu-config.service */
    "./src/app/core/services/menu-config.service.ts");
    /* harmony import */


    var _core_services_songs_config_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _content_layout_loader_loader_component__WEBPACK_IMPORTED_MODULE_7__["LoaderComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _content_layout_layout_module__WEBPACK_IMPORTED_MODULE_6__["LayoutModule"]],
      providers: [_core_services_loading_service__WEBPACK_IMPORTED_MODULE_8__["LoadingService"], _core_services_menu_config_service__WEBPACK_IMPORTED_MODULE_9__["MenuConfigService"], _core_services_songs_config_service__WEBPACK_IMPORTED_MODULE_10__["SongsConfigService"]],
  ...
  function srcAppConfigAlbumsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AlbumsConfig = function AlbumsConfig(api) {
      var _this = this;
      ...
      this.api.postWithAuth("home/third/list", {}).subscribe(function (res) {
        if (res.success) {
          var datas = res.data;
  ...
  function srcAppConfigArtistsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ArtistsConfig = /*#__PURE__*/function () {
      function ArtistsConfig(api) {
        var _this2 = this;
        ...
        this.api.postWithAuth("home/second/list", {}).subscribe(function (res) {
          console.log(res);
      ...
      _createClass(ArtistsConfig, [{
        key: "GetArtistSongsByArtistID",
        value: function GetArtistSongsByArtistID(id) {
          var _this3 = this;

          var skip = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
          this.api.postWithAuth("artist/songs", {
            artist_id: id,
            skip: skip
            ...
            if (res.success) {
              var songs = res.data;
              _this3.config.details = res.artist_detail;
              songs.forEach(function (element) {
                _this3.config.items.push({
                  id: element.song_id,
                  premium: true,
                  favorite: false,
                  name: element.title,
  ...
  function srcAppConfigSongsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SongsConfig = function SongsConfig(api) {
      var _this4 = this;
      ...
      this.api.postWithAuth("home/first/list", {}).subscribe(function (res) {
        console.log(res);

        if (res.success) {
          var datas = res.data;
          var trending = datas.trending.data;
          trending.forEach(function (element) {
            _this4.config.items.push({
              id: element.song_id,
              premium: true,
              favorite: false,
              name: element.title,
          ...
          _this4.config.count = trending.length; // this.setState({
          //   first_section_items: response.data.data,
          //   isLoaded: true,
          //   banner_length: datas.banner.data.length,
          //   recent_activities_length: datas["recent activities"].data.length,
      ...
      _createClass(AsideLeftComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.skinSubscription = this.skinService.themeSkin.subscribe(function (skin) {
            if (skin) {
              _this5.sidebarClass = 'sidebar-' + _config_config__WEBPACK_IMPORTED_MODULE_5__["Config"].THEME_CLASSES[skin.sidebar];
            }
          });
        }
      }, {
    ...
    var HeaderComponent = /*#__PURE__*/function () {
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.themeSkin) {
            this.headerClasses = 'bg-' + _config_config__WEBPACK_IMPORTED_MODULE_8__["Config"].THEME_CLASSES[this.themeSkin.header];
          }

          this.searchSubscription = this.searchService.searchStatus.subscribe(function (value) {
            if (value) {
              _this7.hideSearchResults();
            }
          });
          this.skinSubscription = this.skinService.themeSkin.subscribe(function (skin) {
            if (skin) {
              _this7.headerClasses = 'bg-' + _config_config__WEBPACK_IMPORTED_MODULE_8__["Config"].THEME_CLASSES[skin.header];
            }
          });
        }
      }, {
  ...
  function srcAppContentLayoutHeaderLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_services_local_storage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../../core/services/local-storage.service */
    "./src/app/core/services/local-storage.service.ts");
    /* harmony import */
    ...
    var LoginComponent = /*#__PURE__*/function (_ngx_simple_modal__WE2) {
      ...
      function LoginComponent(localStorageService, router) {
        var _this8;

        _classCallCheck(this, LoginComponent);

        _this8 = _super2.call(this);
        _this8.localStorageService = localStorageService;
      ...
      _createClass(LoginComponent, [{
        ...
        value: function submitLogin() {
          ...
          this.localStorageService.setLocalStorage(_config_config__WEBPACK_IMPORTED_MODULE_6__["Config"].CURRENT_USER, user);
          this.close();
    ...
    LoginComponent.ctorParameters = function () {
      return [{
        type: _core_services_local_storage_service__WEBPACK_IMPORTED_MODULE_5__["LocalStorageService"]
      }, {
  ...
  function srcAppContentLayoutHeaderProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_services_menu_config_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../../../core/services/menu-config.service */
    "./src/app/core/services/menu-config.service.ts");
    /* harmony import */
    ...
    var _core_services_local_storage_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../../../core/services/local-storage.service */
    "./src/app/core/services/local-storage.service.ts");
    /* harmony import */
    ...
    var ProfileComponent = /*#__PURE__*/function () {
      function ProfileComponent(searchService, localStorageService, menuConfigService, router, simpleModalService) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function openLoginModal() {
          ...
          var modal = this.simpleModalService.addModal(_login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"], {}).subscribe(function (isConfirmed) {
            if (isConfirmed) {} else {}
          });
        }
      }, {
        ...
        value: function logout() {
          this.localStorageService.clearLocalStorage(_config_config__WEBPACK_IMPORTED_MODULE_8__["Config"].CURRENT_USER);
          var currentUrl = this.router.url;
    ...
    ProfileComponent.ctorParameters = function () {
      return [{
        ...
        type: _core_services_local_storage_service__WEBPACK_IMPORTED_MODULE_7__["LocalStorageService"]
      }, {
        type: _core_services_menu_config_service__WEBPACK_IMPORTED_MODULE_4__["MenuConfigService"]
      }, {
  ...
  function srcAppContentLayoutPlayerPlayerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PlayerComponent = /*#__PURE__*/function () {
      ...
      _createClass(PlayerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.skinSubscription = this.skinService.themeSkin.subscribe(function (skin) {
            if (skin) {
              _this10.playerClass = 'player-' + _config_config__WEBPACK_IMPORTED_MODULE_6__["Config"].THEME_CLASSES[skin.player];
            }
          });
        }
      }, {
    ...
    PlayerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/layout/player/player.component.html"))["default"]
  ...
  function srcAppContentLayoutSectionSectionComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SectionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/layout/section/section.component.html"))["default"]
    })], SectionComponent);
    /***/
  },
  ...
  function srcAppContentPartialsImageCardImageCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ImageCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./image-card.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/image-card/image-card.component.html"))["default"]
    })], ImageCardComponent);
    /***/
  },
  ...
  function srcAppContentPartialsMainCardsPrimaryCardPrimaryCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PrimaryCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./primary-card.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/main-cards/primary-card/primary-card.component.html"))["default"]
  ...
  function srcAppContentPartialsMainCardsSecondaryCardSecondaryCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SecondaryCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./secondary-card.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/main-cards/secondary-card/secondary-card.component.html"))["default"]
  ...
  function srcAppContentPartialsSongHorizontalSongHorizontalComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SongHorizontalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./song-horizontal.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/song-horizontal/song-horizontal.component.html"))["default"]
  ...
  function srcAppContentPartialsSongListViewSongListViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SongListViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./song-list-view.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/content/partials/song-list-view/song-list-view.component.html"))["default"]
  ...
  function srcAppCoreServicesAlbumsConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _config_albums__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../config/albums */
    "./src/app/config/albums.ts");

    var AlbumsConfigService = /*#__PURE__*/function () {
      function AlbumsConfigService(api) {
        _classCallCheck(this, AlbumsConfigService);

        this.api = api;
        this.albumsConfig = new _config_albums__WEBPACK_IMPORTED_MODULE_3__["AlbumsConfig"](this.api);
      }
  ...
  function srcAppCoreServicesArtistsConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _config_artists__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../config/artists */
    "./src/app/config/artists.ts");

    var ArtistsConfigService = /*#__PURE__*/function () {
      function ArtistsConfigService(api) {
        _classCallCheck(this, ArtistsConfigService);

        this.api = api;
        this.artistsConfig = new _config_artists__WEBPACK_IMPORTED_MODULE_3__["ArtistsConfig"](this.api);
      }
    ...
    var AudioPlayerService = /*#__PURE__*/function () {
      ...
      _createClass(AudioPlayerService, [{
        ...
        value: function playNowPlaylist(playlist) {
          ...
          if (!amplitudejs__WEBPACK_IMPORTED_MODULE_2__["getActivePlaylist"]()) {
  ...
  function srcAppCoreServicesSongsConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _config_songs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../config/songs */
    "./src/app/config/songs.ts");

    var SongsConfigService = /*#__PURE__*/function () {
      function SongsConfigService(api) {
        _classCallCheck(this, SongsConfigService);

        this.api = api;
        this.songsConfig = new _config_songs__WEBPACK_IMPORTED_MODULE_3__["SongsConfig"](this.api);
      }
  ...
  function srcAppServiceApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      function ApiService(http) {
        ...
        this.APIGlobeSetting = {};
      }

      _createClass(ApiService, [{
        key: "postWithOutAuth",
        value: function postWithOutAuth(endPoint, data) {
          return this.http.post("".concat(this.baseURL).concat(endPoint), data);
        }
      }, {
        key: "getWithOutAuth",
        value: function getWithOutAuth(endPoint) {
          return this.http.get("".concat(this.baseURL).concat(endPoint));
        }
      }, {
        key: "postWithAuth",
        value: function postWithAuth(endPoint, object) {
          var userId = localStorage.getItem('userId') !== '' && localStorage.getItem('userId') !== null && localStorage.getItem('userId') !== undefined ? localStorage.getItem('userId') : '';
          var accessToken = localStorage.getItem('accessToken') !== '' && localStorage.getItem('accessToken') !== null && localStorage.getItem('accessToken') !== undefined ? localStorage.getItem('accessToken') : '';
          var url = this.baseURL + endPoint;
          var formData = new FormData(); // By Default Id and token
          ...
          if (!socialLoginUser) {
            formData.append('login_by', src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].LOGIN_BY);
          }

          formData.append('device_type', src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].DEVICE_TYPE);
          formData.append('device_token', src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].DEVICE_TOKEN);
          return this.http.post("".concat(url), formData);
        }
      }, {
        key: "getWithAuth",
        value: function getWithAuth(endPoint) {
          var tok = 'Bearer ' + localStorage.getItem('token');
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      baseurl: 'https://admin.wazo.live/api/',
      production: false,
      LOGIN_BY: 'manual',
      DEVICE_TYPE: 'web',
      DEVICE_TOKEN: '123456'
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\PROJECTS\wazo\wazo-frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
